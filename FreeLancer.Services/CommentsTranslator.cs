...
namespace FreeLancer.Services
{
    ...
    public partial class CommentsTranslator
    {
        ...
        public static ICollection<Comment> ConvertToCommentEntity(ICollection<CommentContract> comments)
        {
        ...
        public static CommentContract ConvertToCommentContract(Comment comment)
        {
            ...
            CommentContract contractComment = new CommentContract()
            {
                ...
                ProfileID = comment.ProfileID,
                Date = comment.Date,
                Profile = ProfilesTranslator.ConvertToProfileContract(comment.Profile),
                User = UsersTranslator.ConvertToUserContract(comment.User),
            };
            return contractComment;
        }

        public static ICollection<CommentContract> ConvertToCommentContract(ICollection<Comment> comments)
        {
