...
public static ICollection<Project> ConvertToProjectEntity(ICollection<ProjectContract> projects){
...
ProjectContract contractProject = new ProjectContract(){
            ...
            ProjectID=project.ProjectID,UserID=project.UserID,SubCategoryID=project.SubCategoryID,Description=project.Description,AverageCost=project.AverageCost,StartDate=project.StartDate,EndDate=project.EndDate,Finished=project.Finished,FreelancerID=project.FreelancerID,Date=project.Date,Featured=project.Featured,Name=project.Name,
                Competitors=CompetitorsTranslator.ConvertToCompetitorContract(project.Competitors),
                SubCategory=SubCategorysTranslator.ConvertToSubCategoryContract(project.SubCategory),
                User=UsersTranslator.ConvertToUserContract(project.User),
                UsersNotified=UsersTranslator.ConvertToUserContract(project.UsersNotified),};
return contractProject;}

public static ICollection<ProjectContract> ConvertToProjectContract(ICollection<Project> projects){
