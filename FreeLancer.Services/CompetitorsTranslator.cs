...
namespace FreeLancer.Services
{
    ...
    CompetitorContract contractCompetitor = new CompetitorContract(){
                ...
                ProjectID=competitor.ProjectID,UserID=competitor.UserID,Cost=competitor.Cost,Duration=competitor.Duration,                Project=ProjectsTranslator.ConvertToProjectContract(competitor.Project),                User=UsersTranslator.ConvertToUserContract(competitor.User),};
